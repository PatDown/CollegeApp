...
public class ApplicantActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if (title == null) title = drawerTitle = "TestTitle";
        mDrawerLayout = (DrawerLayout)findViewById(R.id.drawer_layout);
        NavActionBarDrawerToggle drawerToggle = new NavActionBarDrawerToggle(this);
        DrawerListItemClickListener drawerListItemClickListener = new DrawerListItemClickListener();
